...
public class DijkstraSP2 {
     ...
     */
    public DijkstraSP2(EdgeWeightedGraph G, int s) {
        for (Edge e : G.edges()) {
            if (e.distance() < 0)
                ...
                if (sp.hasPathTo(t)) {
                    ...
                    for (Edge e : sp.pathTo(t)) {
                    	if (e!=e2){
                    		if(i==0){
                    			if (e.either()==t){
                    				System.out.print(e.either() +" "+e.distance()+ " "+e.other(e.either())+" ");
                    				nexte=e.other(e.either());
                    			}
                    			else{
                    				System.out.print(e.other(e.either()) +" "+e.distance()+ " "+e.either()+" ");
                    				nexte=e.either();
                    			}
	                    	}
                    		else {
                    			if (e.either()==nexte){
                    				System.out.print(e.distance()+" "+ e.other(e.either())+" ");
                    				nexte=e.other(e.either());
                    			}
                    			else{
                    				System.out.print(e.distance()+" "+ e.either()+" ");
                    				nexte=e.either();
                    			}
                    		}
	                    	e2=e;
